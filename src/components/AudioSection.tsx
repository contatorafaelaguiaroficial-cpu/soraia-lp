      ...
      <Container className="grid items-center gap-14 lg:grid-cols-2">
        ...
        <div className="mx-auto w-full max-w-sm">
          <div className="card-surface rounded-3xl p-6">
              ...
              <div className="flex flex-1 items-center gap-[3px]">
                {[6, 10, 16, 9, 20, 12, 7, 15, 8, 18, 10, 6, 13, 9].map(
                  (h, i) => (
                    <span
                      key={i}
                      className="w-[3px] rounded-full bg-gradient-to-t from-violet-400/70 to-teal-300/70"
                      style={{ height: `${h}px` }}
                    />
                  )
                )}
            ...
            <div className="mt-5 flex items-center gap-2 rounded-xl border border-emerald-400/20 bg-emerald-400/[0.08] px-4 py-3 text-sm font-medium text-emerald-300">
